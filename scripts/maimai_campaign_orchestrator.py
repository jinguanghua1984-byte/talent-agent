    ...
    if _is_broad_recall_strategy_path(strategy):
        ...
        commands = [
            ...
            _command_entry(
                ...
                extra={
                    "consumes": [str(live_plan), strategy, str(adaptive_state), str(seen_candidates)],
                    "produces": [str(live_run), str(page_quality_jsonl), str(adaptive_state), str(seen_candidates)],
                },
            ),
            _command_entry(
