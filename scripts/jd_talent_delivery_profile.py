...
def _title_aliases(title: str) -> list[str]:
    ...
    if "金融" in title:
        aliases.extend(["金融产品经理", "金融数据产品经理", "财经产品经理"])
    if "医疗" in title:
        aliases.extend(["医疗产品经理", "医疗健康产品经理", "医学内容产品经理"])
    if "创作" in title:
        aliases.extend(["内容产品经理", "创作工具产品经理", "AIGC产品经理"])
    if "法务" in title or "法律" in title:
        aliases.extend(["法务产品经理", "法律产品经理", "合规产品经理"])
    if "对话" in title:
        aliases.extend(["对话产品经理", "用户研究产品经理", "社区产品经理"])
    if "知识问答" in title:
        aliases.extend(["问答产品经理", "知识产品经理", "搜索产品经理"])
