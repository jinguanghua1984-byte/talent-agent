...
- [ ] 脚本清理和 hygiene 第一轮实施（2026-05-27）：执行 `docs/superpowers/plans/2026-05-26-script-cleanup-and-hygiene.md`，将测试文件迁出 `scripts/`，移除已替代 legacy 入口，建立脚本清单和护栏测试；Hunyuan ABC 一次性脚本已获确认并删除，当前继续推进 data manager 入口兼容改造。
