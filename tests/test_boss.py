...
class TestBossParseWorkYears(unittest.TestCase):
    ...
    def _call(self, raw):
        from scripts.platform_match.adapters.boss import _parse_work_years
...
class TestBossParseAge(unittest.TestCase):
    ...
    def _call(self, raw):
        from scripts.platform_match.adapters.boss import _parse_age
...
class TestBossNormalizePeriod(unittest.TestCase):
    ...
    def _call(self, raw):
        from scripts.platform_match.adapters.boss import _normalize_period
...
class TestBossParseGeekWork(unittest.TestCase):
    ...
    def _call(self, geek_work):
        from scripts.platform_match.adapters.boss import _parse_geek_work
...
class TestBossParseGeekEdu(unittest.TestCase):
    ...
    def _call(self, geek_edu):
        from scripts.platform_match.adapters.boss import _parse_geek_edu
...
class TestBossAdapterRegistered(unittest.TestCase):
    ...
    def test_search_imports_from_adapters(self):
        from scripts.platform_match.adapters import ADAPTERS as registry_adapters
        from scripts.platform_match.search import ADAPTERS as search_adapters
